/* ==========================================================================
   桥见川渝 · 语料库术语表（corpus glossary）
   来源：语料库资料.zip 的 14 组 CN/EN .docx 平行语料，人工校订后的
        川渝专名 / 文化词官方英文译法。
   作用：注入「翻译 / 改稿」prompt 的术语表，让 AI 对川渝专名翻译一致
...
QJC.corpus = {
  glossary: {
    ...
    /* —— 非遗 · 艺术（巴蜀）—— */
    "川剧":         { en: "Sichuan Opera (Chuanju)", region: "巴蜀" },
    ...
    "四川清音":     { en: "Sichuan Qingyin (clear tune)", region: "巴蜀" },
    ...
    /* —— 历史 · 人物 · 红岩 —— */
    "巴国":         { en: "the State of Ba", region: "巴蜀" },
    "巴蔓子":       { en: "Bamanzi (a general of the State of Ba)", region: "重庆" },
    "廪君":         { en: "Linjun (founder of the Ba people)", region: "巴蜀" },
    "巴渝舞":       { en: "Bayu Dance", region: "巴蜀" },
    "涂山":         { en: "Tushan Mountain", region: "重庆" },
    "大禹":         { en: "Yu the Great", region: "巴蜀" },
