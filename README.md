...
面向内容创作者的**川渝中译英 AI 改稿工作台**：粘贴中文原稿，自动识别川渝文化表达、生成英文译文，并可针对任意段落**对话协商改稿**，同时累积生成你的**写作画像**。
...
├── about.html        # 项目介绍（桥见川渝）
├── css/style.css     # 设计系统 + 组件样式
├── js/
│   ├── config.js     # 模型 / 代理地址 / 常量
│   ├── data.js       # 川渝词典、双语案例、领域/体裁/风格枚举
